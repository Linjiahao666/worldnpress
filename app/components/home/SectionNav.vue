...
<template>
  <section
    class="bg-linear-to-b from-slate-50 to-white rounded-xl border border-slate-200 overflow-hidden"
  >
    <!-- 标题 -->
    <div
      class="flex items-center gap-2 px-5 py-3 border-b border-slate-100 bg-white"
    >
    ...
    <div class="p-4">
      ...
      <div v-if="newsTypeSections?.length" class="mb-3">
        <div class="flex flex-wrap gap-2">
          <NuxtLink
            ...
            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-all bg-blue-50 text-blue-700 hover:bg-blue-100 hover:shadow-sm border border-blue-100"
          >
            <UIcon
      ...
      <div v-if="specialSections?.length">
        <div class="flex flex-wrap gap-2">
          ...
          <NuxtLink
            :to="localePath('/about')"
            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-all bg-slate-100 text-slate-600 hover:bg-slate-200 hover:shadow-sm border border-slate-200"
          >
